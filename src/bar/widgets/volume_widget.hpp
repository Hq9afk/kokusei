...
inline Pill volume_pill(MonitorOutput &mon) {
...
inline void volume_pill_handle_wheel(MonitorOutput &mon, double dy) {
...
inline void volume_pill_peek_tick(MonitorOutput &mon) {
...
inline bool volume_pill_peek_expire(MonitorOutput &mon) {
