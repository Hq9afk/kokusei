...
#include "../core/log.h"
#include "../launcher/spawn.h"
#include "../wayland/layer_surface.h"
#include "logout_draw.h"
...
void trigger_highlight(LogoutState &state, int from_index, int to_index) {
...
void start_button_stagger_in(LogoutState &state) {
    for (int i = 0; i < kLogoutButtonCount; ++i) {
...
bool logout_init_egl(LogoutState &state, Renderer &renderer, EGLDisplay display,
